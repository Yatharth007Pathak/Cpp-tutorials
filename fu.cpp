...
for(int j=1; j<=m; j++) { ... }: This inner for loop iterates from 1 to m, controlling the number of '*' symbols to be printed in each row. 
It prints '*' followed by a space.
