...
// print square pattern using # with cross made of * in the center

/*
This C++ program prints a square pattern with a cross made of asterisks (*) in the center. 
...
int mid = m/2 + 1;: Calculates the middle row and middle column of the square. 
Since m is assumed to be odd, (m/2 + 1) gives the index of the middle row and column.
...
Otherwise, it prints a hash symbol (#) to fill the other parts of the square.
